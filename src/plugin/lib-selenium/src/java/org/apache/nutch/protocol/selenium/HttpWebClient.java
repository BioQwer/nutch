...
public class HttpWebClient {
	...
	public static WebDriver getDriverForPage(String url, Configuration conf) {
		...
		try {
			...
			case "remote":
				...
				LOG.error("Selenium optimized: {}", optimized);
				optimized = true;
	...
	public static RemoteWebDriver createFirefoxRemoteWebDriver(URL seleniumHubUrl,
      boolean enableHeadlessMode, boolean optimized) {
    FirefoxOptions firefoxOptions = new FirefoxOptions();
    if (enableHeadlessMode) {
	...
	public static RemoteWebDriver createDefaultRemoteWebDriver(URL seleniumHubUrl, boolean enableHeadlessMode) {
		return createFirefoxRemoteWebDriver(seleniumHubUrl, enableHeadlessMode, false);
	}
